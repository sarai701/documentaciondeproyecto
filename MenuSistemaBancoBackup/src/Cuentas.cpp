...
Bitacora Cuentas::bitacoraCuentas; // Inicializa una instancia estática de Bitacora.
...
void Cuentas::menuTipoCuenta(const std::string& bancoNombre) { // Método para mostrar el menú de tipos de cuenta.
    ...
    do {
        ...
        switch (opcion) { // Estructura de control para manejar la opción seleccionada.
            case 1: // Si la opción es 1.
                ...
                bitacoraCuentas.insertar("Admin", 4610, "Cuentas", "Cuenta Corriente seleccionada"); // Registra la selección en la bitácora.
                return; // Sale del método.
            case 2: // Si la opción es 2.
                tipoCuentaSeleccionada = "Ahorro"; // Establece tipoCuentaSeleccionada a "Ahorro".
                bitacoraCuentas.insertar("Admin", 4611, "Cuentas", "Cuenta de Ahorro seleccionada"); // Registra la selección en la bitácora.
                return; // Sale del método.
...
std::string Cuentas::getTipoCuenta() const { // Método para obtener el tipo de cuenta seleccionada.
